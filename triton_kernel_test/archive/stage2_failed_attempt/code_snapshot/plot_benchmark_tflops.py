...
# Stage 2: HMMA-reduce (v3a) and late-cast (v3b) vs v2c_at baseline.
STAGE2_COMPARE_PROVIDERS = [
    "triton",
    "triton_abft_v2c_at_kernel",
    "triton_abft_v2c_at_full",
    "triton_abft_v3a_kernel",
    "triton_abft_v3a_full",
    "triton_abft_v3b_kernel",
    "triton_abft_v3b_full",
]
...
def main():
    ...
    stage2_output = Path(__file__).resolve().parent / "plots/tflops_compare_stage2.png"
    _plot_if_available(
        rows,
        STAGE2_COMPARE_PROVIDERS,
        stage2_output,
        plot_tflops_vs_dim,
        title="TFLOPS vs Matrix Dimension (Stage2: v3a HMMA-reduce, v3b late-cast vs v2c_at)",
    )
